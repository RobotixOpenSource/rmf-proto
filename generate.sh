...
protoc --go_out=plugins=grpc:/home/anand/go/src/ ./protos/rcc/v1/rmf.proto

# This line is for compiling python files for the rmf.proto file
python3 -m grpc_tools.protoc -I. --python_out=/home/anand/go/src/github.com/RobotixOpenSource/rmf-proto --grpc_python_out=/home/anand/go/src/github.com/RobotixOpenSource/rmf-proto ./protos/rcc/v1/rmf.proto
